...
define( 'DB_NAME', 'cj97376_dmznl' );

/** Имя пользователя базы данных */
define( 'DB_USER', 'cj97376_dmznl' );

/** Пароль к базе данных */
define( 'DB_PASSWORD', '794dyL7O' );
...
define( 'WP_GOOGLE_LOGIN_CLIENT_ID', '     529222429974-q0d4ojrlhsfjl2kqbs1g6eddmfq5mnck.apps.googleusercontent.com ' );
define( 'WP_GOOGLE_LOGIN_SECRET', ' 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
' );
define( 'WP_GOOGLE_LOGIN_USER_REGISTRATION', 'true' );
define( 'WP_GOOGLE_LOGIN_WHITELIST_DOMAINS', 'cj97376-wordpress-dmznl.tw1.ru' );
